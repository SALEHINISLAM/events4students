  ...
  return (
    <div className="min-h-screen bg-base-100 p-6 text-black">
      <div className="container mx-auto">
        ...
        >
          <h1 className="text-3xl font-bold mb-6">Edit Event: {eventData?.title}</h1>
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="bg-base-100 p-6 rounded-lg shadow">
              ...
              <div className="mb-4">
                ...
                {errors.eventDescription && (
                  <p className="text-red-500 text-xs mt-1">Event description is required</p>
                )}
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-4 mb-4">
                ...
                <div>
                  <label className="block text-sm font-medium mb-1">Event Social Media Link</label>
                  <input
                    type="url"
                    className="w-full p-2 border rounded"
                    placeholder="https://..."
              ...
              <div className="mb-4">
                <label className="block text-sm font-medium mb-1">Event Cover Photo</label>
                {previewImage && (
                  <div className="mb-4">
              ...
              <div className="mb-4">
                <label className="block text-sm font-medium mb-1">Verified Event</label>
                <input
                  type="checkbox"
                  className="toggle"
                  {...register('isVerified')}
            ...
            <div className="bg-base-100 p-6 rounded-lg shadow">
              ...
              <div className="mb-4">
                <label className="block text-sm font-medium mb-1">Organizing Institution/Club *</label>
                <input
                  type="text"
                  className="w-full p-2 border rounded"
            ...
            <div className="bg-base-100 p-6 rounded-lg shadow">
              ...
              <div className="mb-4">
                <label className="block text-sm font-medium mb-1">Are you part of the organizing committee? *</label>
                <div className="flex space-x-4">
                  <label className="inline-flex items-center">
                    <input
                      type="radio"
              ...
              <div className="mb-4">
                <label className="block text-sm font-medium mb-1">Your Role in the Organization</label>
                <input
                  type="text"
                  className="w-full p-2 border rounded"
              ...
              <div className="mb-4">
                ...
                />
                <p className="text-xs text-gray-500 mt-1">Upload a new document if you want to update the existing one</p>
              </div>
            </div>
