  ...
  return (
    <div className="min-h-screen bg-base-100 p-6 text-black">
      <div className="container mx-auto">
        ...
        >
          <h1 className="text-3xl font-bold mb-6">Delete Events</h1>

          {/* Navigation */}
          <div className="tabs mb-8">
            <Link href="/admin" className="tab tab-bordered">
              Approve/Modify Events
            </Link>
            <a className="tab tab-bordered tab-active">Delete Events</a>
          </div>

          {/* All Events for Deletion */}
